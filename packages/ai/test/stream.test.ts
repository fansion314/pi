...
describe("Generate E2E Tests", () => {
	...
	describe.skipIf(!process.env.DEEPSEEK_API_KEY)("DeepSeek Provider (deepseek-flash via OpenAI Responses)", () => {
	...
	describe.skipIf(!process.env.DEEPSEEK_API_KEY)(
		"DeepSeek Legacy Provider (deepseek-flash via OpenAI Completions)",
		() => {
			const llm = getModel("deepseek-completions", "deepseek-flash");
