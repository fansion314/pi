...
// dnr's node:module does not implement Node's persistent compile cache.
// Keep Node's optimized launcher, and load the same runtime as ESM in DNP.
const cliLauncher = dnpBundleDir ? `#!/usr/bin/env node
